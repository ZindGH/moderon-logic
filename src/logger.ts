...
export class Logger {
	...
	private readonly outputChannel = lazy(() => vscode.window.createOutputChannel('ANSI C'));
	...
	private readTrace(): Trace {
		return Trace.fromString(vscode.workspace.getConfiguration().get<string>('ansi-c.trace', 'off'));
	}
